...
if (!isset($_SESSION['username'])) {
    ...
    exit();
} elseif ($_SESSION['role'] == 'student' || $_SESSION['role'] == 'teacher') {
    header("location:login.php");
    exit();
}
            ...
            <table border="1px">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($info = $result->fetch_assoc()) {
                        ...
                        echo "<td class='table_td'><a class='delete_btn' onclick=\"return confirm('Are you sure you want to delete this student?');\" href='delete.php?student_id=" . $info['id'] . "'>Delete</a></td>";
                        echo "<td class='table_td'><a class='update_btn' href='update_student.php?id=" . $info['id'] . "'>Update</a></td>";
                        echo "</tr>";
                    }
                } else {
