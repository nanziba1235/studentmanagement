            ...
            <table border="1px">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td class='table_td'><a class='delete_btn' onclick=\"return confirm('Are you sure you want to delete this attendance record?');\" href='delete_attendance.php?id=" . $row['attendance_id'] . "'>Delete</a></td>";
                        echo "<td class='table_td'><a class='update_btn' href='update_attendance.php?id=" . $row['attendance_id'] . "'>Update</a></td>";
                        echo "</tr>";
                    }
                } else {
